        ...
        <div class="col-md-9">
            <div class="panel">
                <div class="panel-body">
                    <?php
 echo '<table class="table table-striped ">'; echo '<tr><td><strong>队伍</strong></td><td><strong>比分</strong></td><td><strong>队伍</strong></td><td><strong>陈逗逼下的注</strong></td><td><strong>谢逗逼下的注</strong></td><td><strong>高逗逼下的注</strong></td><td><strong>公款</strong></td></tr>'; for ($count = $finish_count; $count>=0; $count--) { $public_money[$count] = -round($record["xwj_money"][$count]+$record["cyx_money"][$count]+$record["ghw_money"][$count], 2); if ($public_money[$count]>=0) $public_money[$count] = " + ¥".$public_money[$count]; else $public_money[$count] = " - ¥".(-1*$public_money[$count]); echo '<tr>'; echo '<td>'. $team[$count*2] .'</td>'. '<td>'.$score[$count] .'</td>'. '<td>'.$team[$count*2+1] .'</td>'; if ($record["cyx_money"][$count]>=0) $record["cyx_money"][$count] = " + ¥".$record["cyx_money"][$count]; else $record["cyx_money"][$count] = " - ¥".(-1*$record["cyx_money"][$count]); if ($record["xwj_money"][$count]>=0) $record["xwj_money"][$count] = " + ¥".$record["xwj_money"][$count]; else $record["xwj_money"][$count] = " - ¥".(-1*$record["xwj_money"][$count]); if ($record["ghw_money"][$count]>=0) $record["ghw_money"][$count] = " + ¥".$record["ghw_money"][$count]; else $record["ghw_money"][$count] = " - ¥".(-1*$record["ghw_money"][$count]); echo '<td>'. $record["cyx_bet"][$count].$record["cyx_money"][$count] .'</td><td>'. $record["xwj_bet"][$count].$record["xwj_money"][$count].'</td><td>' .$record["ghw_bet"][$count]. $record["ghw_money"][$count].'</td>'; echo '<td>'.$public_money[$count].'</td>'; echo '</tr>'; } echo '</table>'; ?>                              
                </div>
